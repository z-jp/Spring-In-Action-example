...
public class JdbcSpitterRepositoryTest {
    ...
    @Transactional
    public void findOne() {
        assertSpitter(0, spitterRepository.findById(1L));
        assertSpitter(1, spitterRepository.findById(2L));
        assertSpitter(2, spitterRepository.findById(3L));
        assertSpitter(3, spitterRepository.findById(4L));
    }
    ...
    public void save_newSpitter() {
        ...
        assertSpitter(4, spitterRepository.findById(5L));
    }
    ...
    public void save_existingSpitter() {
        ...
        assertEquals(4, spitterRepository.count());
        Spitter updated = spitterRepository.findById(4L);
